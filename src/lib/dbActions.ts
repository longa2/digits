...
{ firstName: string; lastName: string; address: string; image: string; description: string; owner: string; }) {
  // console.log(`addContact data: ${JSON.stringify(stuff, null, 2)}`);
 ...
 * @param note, an object with the following properties: contactId, note, owner, createdAt.
 */
...
export async function editContact(contact: Contact) {
  // console.log(`editContact data: ${JSON.stringify(stuff, null, 2)}`);
